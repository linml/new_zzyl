...
final class CenterNotify
{
     ...
     * @param $moneyLimit
     */
    public static function userStatus($userID, $type, $statusValue, $otherValue, $moneyLimit,$ctrlPercent)
    {
        $struct = StructConfig::userStatus($type, $statusValue, $otherValue, $moneyLimit,$ctrlPercent);
